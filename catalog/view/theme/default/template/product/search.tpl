...
<div id="block-body">
  ...
  <div id="content"> <!-- THIS DIV IS NECESSARY FOR JS!-->
    <p><?php echo $entry_search; ?>
      <?php if ($search) { ?>
      <input id="mod-search" type="text" name="search" size="50" value="<?php echo $search; ?>" />
      <?php } else { ?>
      <input id="mod-search" type="text" name="search" size="50" value="<?php echo $search; ?>" onclick="this.value = '';" onkeydown="this.style.color = '000000'" style="color: #999;" />
      <?php } ?>
