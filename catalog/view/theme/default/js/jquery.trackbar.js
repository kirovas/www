...
// Methods
	...
	init : function(hash) {
		try {
			...
			this.jq = hash.jq;
			// HTML Write
			this.jq.html('<div>Цена</div><table' + (this.width ? ' style="width:'+this.width+'px;"' : '') + 'class="trackbar" onSelectStart="return false;">\
				<tr>\
					<td class="l"><div id="leftBlock"><span></span><span class="limit"></span><img id="leftBegun" ondragstart="return false;" src="/catalog/view/theme/default/css/imgtrackbar/b_l.png" width="6" height="17" alt="" /></div></td>\
					<td class="c" id="centerBlock"></td>\
					<td class="r"><div id="rightBlock"><span></span><span class="limit"></span><img id="rightBegun" ondragstart="return false;" src="/catalog/view/theme/default/css/imgtrackbar/b_r.png" width="6" height="17" alt="" /></div></td>\
				</tr>\
			</table>');
			// Is all right?
			if (this.onMove == null) {
