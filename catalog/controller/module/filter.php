...
class ControllerModuleFilter extends Controller {
	protected function index() {
		if (isset($this->request->get['path'])) {
			...
			$this->request->get['path'] = '62';
			$parts = array();
		}
		$category_id = 62;//end($parts);
		...
		if ($category_info) {
			...
			if ($filter_groups) {
				...
				$this->data['leftvalue'] = (isset($this->request->get['minprice'])) ? (int)$this->request->get['minprice'] : 10000;
				$this->data['rightvalue'] = (isset($this->request->get['maxprice'])) ? (int)$this->request->get['maxprice'] : 30000;
