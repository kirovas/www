...
class ControllerModuleSlideshow extends Controller {
	protected function index($setting) {
		...
		$this->document->addScript('/catalog/view/theme/default/js/jquery.nivo.slider.pack.js');
		...
		//$this->document->addStyle('catalog/view/theme/default/stylesheet/slideshow.css');
		$this->document->addStyle('/catalog/view/theme/default/css/slider/nivo-slider.css');
		$this->document->addStyle('/catalog/view/theme/default/css/slider/default.css');
